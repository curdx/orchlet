...
const requiredCommands = new Set([
  ...
  "profile_avatar_preset_select",
  "profile_avatar_reset",
  "profile_avatar_delete_uploaded",
  "shortcut_preferences_get",
  "shortcut_preferences_update",
  "shortcut_preferences_reset",
  "chat_terminal_output_preferences_get",
  "chat_terminal_output_preferences_update",
  "chat_terminal_output_preferences_reset",
  "terminal_configuration_get",
  "terminal_configuration_update",
  "terminal_configuration_reset",
  "contacts_list",
  "contact_create",
  "contact_update",
  "contact_delete",
